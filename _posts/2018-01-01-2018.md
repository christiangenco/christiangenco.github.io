...
### Week 05: publish React TDD outline, get current on admin work (email, gtd, taxes, groove, physical inboxes), React 16 - The Complete Guide outline, start 30x500

1. **2018-01-29**: gtd (4/4), trigg magic (1/0), email (3/3) = 8
2. **2018-01-30**: React 16 (4/4), 30x500 (2/4), *trigg magic* = 6
3. **2018-01-31**:
4. **2018-02-01**:
5. **2018-02-02**:
6. **2018-02-03**:
...
* Automate distractions: looking for glasses and phone, watching Starcraft videos on Youtube before poms are done

    homework: tackle one repetitive task and design a workflow
    task: gatd terminal command to do `git add . && git commit -m "2018-01-30"`
    workflow: bedtime checklist
