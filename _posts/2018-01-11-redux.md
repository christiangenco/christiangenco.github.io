...
* [`applyMiddleware`](https://redux.js.org/docs/api/applyMiddleware.html): [monkeypatch `dispatch`](https://redux.js.org/docs/advanced/Middleware.html) to add things like logging, exception handling, action scheduling, dispatching functions with [redux thunk](https://github.com/gaearon/redux-thunk), [dispatching promises in action payloads](https://github.com/acdlite/redux-promise), and [way way more](https://github.com/xgrommx/awesome-redux)
...
* [thunk vs. observable vs. saga vs. promise](https://medium.com/react-native-training/redux-4-ways-95a130da0cdc)
* [cool diagrams of immutable redux flow](https://www.toptal.com/javascript/immutability-in-javascript-using-redux)
