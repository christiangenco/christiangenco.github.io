...
Here's a list of everything that I own that [sparks joy](http://amzn.to/2oYyCpQ) in my life, and that I would replace if stolen. Anything not on this list should be discarded.
...
* **[Himalayan Sea Salt](http://amzn.to/2pdVYIJ)**: might be better than sea salt because it has [extra minerals](https://en.wikipedia.org/wiki/Himalayan_salt). Probably a fad - it's difficult to test.

## Kitchen

* [**Reverse Osmosis Water Filter**](http://amzn.to/2oBRPKp): model doesn't matter. Fluoride might be bad for you, and chlorine makes water taste weird.
